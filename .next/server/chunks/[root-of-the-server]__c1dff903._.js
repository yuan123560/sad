...
"[project]/.next-internal/server/app/api/qanything/stream-direct/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/qanything/stream-direct/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
// 获取或创建知识库
async function getOrCreateKnowledgeBase(apiKey) {
    try {
        // 首先尝试获取现有知识库列表
...
async function POST(request) {
    try {
        ...
        const requestData = {
            ...
            kbIds: body.kbIds && body.kbIds.length > 0 ? body.kbIds : [],
            prompt: body.prompt || '',
            history: body.history || [],
            model: body.model || 'QAnything 4o mini',
            maxToken: body.maxToken || 1024,
            hybridSearch: body.hybridSearch || false,
            networking: body.networking !== undefined ? body.networking : false,
            sourceNeeded: body.sourceNeeded !== undefined ? body.sourceNeeded : true
        };
        // 创建流式响应 - 直接转发模式
            ...
            async start (controller) {
                try {
                    ...
                    const finalRequestData = {
                        ...
                        maxToken: requestData.maxToken || 1024,
                        hybridSearch: requestData.hybridSearch || false,
                        networking: requestData.networking !== undefined ? requestData.networking : false,
                        sourceNeeded: requestData.sourceNeeded !== undefined ? requestData.sourceNeeded : true
                    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c1dff903._.js.map